...
- **Task 4:** Customer Segmentation (K-Means, PCA)  
- **Task 5:** Energy Consumption Forecasting (Prophet)  
- **Task 6:** Bank Marketing Prediction (Classification, LIME Explainability)  
- **Task 7:** Loan Default Risk Prediction (Logistic Regression, Threshold Optimization)
